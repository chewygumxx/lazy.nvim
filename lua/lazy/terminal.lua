...
function M.black(text)
    return M.color(text, "black")
end
---@param text string
---@return string
function M.red(text)
    return M.color(text, "red")
end
---@param text string
---@return string
function M.green(text)
    return M.color(text, "green")
end
---@param text string
---@return string
function M.yellow(text)
    return M.color(text, "yellow")
end
---@param text string
---@return string
function M.blue(text)
    return M.color(text, "blue")
end
---@param text string
---@return string
function M.magenta(text)
    return M.color(text, "magenta")
end
---@param text string
---@return string
function M.cyan(text)
    return M.color(text, "cyan")
end
---@param text string
---@return string
...
---@param text string
---@return string
function M.bright_black(text)
    return M.color(text, "bright_black")
end
---@param text string
---@return string
function M.bright_red(text)
    return M.color(text, "bright_red")
end
---@param text string
---@return string
function M.bright_green(text)
    return M.color(text, "bright_green")
end
---@param text string
---@return string
function M.bright_yellow(text)
    return M.color(text, "bright_yellow")
end
---@param text string
---@return string
function M.bright_blue(text)
    return M.color(text, "bright_blue")
end
---@param text string
---@return string
function M.bright_magenta(text)
    return M.color(text, "bright_magenta")
end
---@param text string
---@return string
function M.bright_cyan(text)
    return M.color(text, "bright_cyan")
end
---@param text string
---@return string
function M.bright_white(text)
    return M.color(text, "bright_white")
end
-- stylua: ignore end
