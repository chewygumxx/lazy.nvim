    ...
    enum: [
        {
            name: "core",
            fullName: "Core",
            description: "Plugin spec, config, and fragment/meta internals",
        },
        {
            name: "manage",
            fullName: "Manage",
            description: "Install, update, clean, and lock pipeline",
        },
        {
            name: "view",
            fullName: "View",
            description: "The :Lazy UI",
        },
        {
            name: "pkg",
            fullName: "Pkg",
            description: "Package metadata sources (rockspec, packspec, lazy.lua)",
        },
        {
            name: "plugin",
            fullName: "Plugin",
            description: "Plugin spec parsing and normalization",
        },
        {
            name: "config",
            fullName: "Config",
            description: "User configuration and defaults",
        },
        {
            name: "git",
            fullName: "Git",
            description: "Git clone/fetch/checkout operations",
        },
        {
            name: "types",
            fullName: "Types",
            description: "LuaCATS type annotations",
        },
        {
            name: "build",
            fullName: "Build",
            description: "Build steps and rockspec generation",
        },
        {
            name: "bootstrap",
            fullName: "Bootstrap",
            description: "bootstrap.lua standalone install script",
        },
        {
            name: "ci",
            fullName: "CI",
        ...
        },
        {
            name: "test",
            fullName: "Test",
            description: "Test suite and mocking helpers",
        },
    ],
};
